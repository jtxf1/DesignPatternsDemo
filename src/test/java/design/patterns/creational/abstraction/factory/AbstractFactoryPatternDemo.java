...
public class AbstractFactoryPatternDemo {
    public static void main(String[] args) {
        //获取形状工厂
        AbstractFactory shapeFactory = Objects.requireNonNull(FactoryEnum.getAbstractFactory("SHAPE"));
        ...
        //获取颜色工厂
        AbstractFactory colorFactory = Objects.requireNonNull(FactoryEnum.getAbstractFactory("COLOR"));
        //获取颜色为 Red 的对象
        Color color1 = null;
